...
import java.util.Scanner;
    ...
    //Criando uma classe FilmeControle que herda os atributos da classe Filme
    public class FilmeControle extends Filme {

        static ArrayList<Integer> idFilmeLista = new ArrayList<>();

        public FilmeControle(int id, String titulo, String diretor, String genero, String classificacao, int duracao, int quantidade, float valor) {
            super(id, titulo, diretor, genero, classificacao, duracao, quantidade, valor);
        }


    //Criando um método para cadastrar o Filme e que irá retornar um objeto FilmeControle
    public static FilmeControle cadastrarFilme(){
        ...
        //Instanciando um Objeto FilmeControle na variável filmeControl, com os atributos escolhidos acima
        filmeControl = new FilmeControle(id, titulo, diretor, genero, classificacao, duracao, quantidade, valor);

        //Retornando a variável filmeControl que o objeto FilmeControle foi instanciado
        return filmeControl;
    ...
    public static void consultarFilme(ArrayList<FilmeControle> listaFilme){
    ...
    public static void listarFilme(ArrayList<FilmeControle> listaFilme){
